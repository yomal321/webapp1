...
function ShoppingBag() {
  return (
    <div className="   bg-yellow-300 min-h-screen">
      <div className=" container  mx-auto py-12 mt-0">
        {/*Header  */}

        <header className="bg-white p-4  m-4 flex items-center justify-between  rounded-3xl ">
          <div className="flex items-center">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="p-2 rounded-full border border-gray-300 focus:outline-none focus:border-gray-500 w-96"
            />
        ...
        <p className="text-gray-600 mb-6 ml-4'"></p>
        <div className="flex justify-between">
          <div>
            <p>
              <span className=" text-xl font-bold ml-4">2 items </span>in your
              bag.
            </p>
          </div>
          {/*back button  */}
        ...
        <div className="grid md:grid-cols-3 gap-4 rounded-full mx-4 ">
          {/* Product List */}
          <div className="md:col-span-2 bg-white p-6 rounded shadow-sm">
            <div className="flex justify-between   font-bold font-serif py-3">
              ...
              <div className="flext  font-bold font-serif">
                <p className="">
                  <span className="px-4 mr-4"> price </span>
                  <span className="px-4"> qty </span>
                  <span className="px-4"> Total price</span>
                </p>
              </div>
            </div>
            {/* Product 1 */}
            <div className="flex items-center justify-between border-b pb-4 mb-4  hover:scale-105 transition-transform duration-300">
              <div className="flex items-center">
                <img
                  src="/images/pb1.jpg"
            ...
            {/* Product 2 */}
            <div className="flex items-center justify-between  border-b  hover:scale-105 transition-transform duration-300">
              <div className="flex items-center">
                <img
                  src="/images/pb2.jpg"
                  alt="Floral Print Wrap Dress"
            ...
            {/*product 03 */}
            <div className="flex items-center justify-between py-4  hover:scale-105 transition-transform duration-300">
              <div className="flex items-center">
                <img
                  src="/images/pb2.jpg"
                  alt="Floral Print Wrap Dress"
          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-600 mb-4">
              ...
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Design
              by Fluttertop
            </p>
            <input
              type="text"
